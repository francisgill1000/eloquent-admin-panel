...
const LeadCountPerAgent = () => {
    ...
    const fetchRecords = async () => {
        try {
            ...
            const { data } = await axios.get("leads/count-per-agent");
    ...
    return (
        <>
            <div className="flex  justify-between">
                <h3 className="text-lg font-semibold text-gray-200">Total Leads Per Agent</h3>
            </div>
                        ...
                        {isLoading ? (
                            ...
                            records.map((item, index) => (
                                ...
                                >
                                    ...
                                    <td className="px-4 py-2">{item.lead_count}</td>
                                </tr>
                            ))
                        )}
                    </tbody>
...
export default LeadCountPerAgent;
